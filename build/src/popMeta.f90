...
subroutine paramMaster(err,message)
  ...
  ! -----------------------
  !                                                        name,        default    ,unit,parent-beta,    TF,   type,    mask
  !ks transfer function
  gammaMeta(ixGamma%ks1gamma1)       = gammaPar_meta('ks1gamma1'      ,   -0.6_dp  ,'-' ,"ks"       ,     1, "soil", .False.)
  gammaMeta(ixGamma%ks1gamma2)       = gammaPar_meta('ks1gamma2'      , 0.0126_dp  ,'-' ,"ks"       ,     1, "soil", .False.)
  gammaMeta(ixGamma%ks1gamma3)       = gammaPar_meta('ks1gamma3'      ,-0.0064_dp  ,'-' ,"ks"       ,     1, "soil", .False.)
  gammaMeta(ixGamma%ks2gamma1)       = gammaPar_meta('ks2gamma1'      ,   54.0_dp  ,'-' ,"ks"       ,     2, "soil", .False.)
  gammaMeta(ixGamma%ks2gamma2)       = gammaPar_meta('ks2gamma2'      ,  -0.07_dp  ,'-' ,"ks"       ,     2, "soil", .False.)
  gammaMeta(ixGamma%ks2gamma3)       = gammaPar_meta('ks2gamma3'      , -0.167_dp  ,'-' ,"ks"       ,     2, "soil", .False.)
  !pororsity transfer function
  gammaMeta(ixGamma%phi1gamma1)      = gammaPar_meta('phi1gamma1'     ,    50.5_dp ,'-' ,"phi"      ,     1, "soil", .False.)
  gammaMeta(ixGamma%phi1gamma2)      = gammaPar_meta('phi1gamma2'     ,  -0.142_dp ,'-' ,"phi"      ,     1, "soil", .False.)
  gammaMeta(ixGamma%phi1gamma3)      = gammaPar_meta('phi1gamma3'     ,  -0.037_dp ,'-' ,"phi"      ,     1, "soil", .False.)
  gammaMeta(ixGamma%phi2gamma1)      = gammaPar_meta('phi2gamma1'     ,    0.76_dp ,'-' ,"phi"      ,     2, "soil", .False.)
  gammaMeta(ixGamma%phi2gamma2)      = gammaPar_meta('phi2gamma2'     ,  0.0009_dp ,'-' ,"phi"      ,     2, "soil", .False.)
  gammaMeta(ixGamma%phi2gamma3)      = gammaPar_meta('phi2gamma3'     ,  -0.264_dp ,'-' ,"phi"      ,     2, "soil", .False.)
  gammaMeta(ixGamma%phi2gamma4)      = gammaPar_meta('phi2gamma4'     ,    0.89_dp ,'-' ,"phi"      ,     2, "soil", .False.)
  gammaMeta(ixGamma%phi2gamma5)      = gammaPar_meta('phi2gamma5'     ,  -0.001_dp ,'-' ,"phi"      ,     2, "soil", .False.)
  gammaMeta(ixGamma%phi2gamma6)      = gammaPar_meta('phi2gamma6'     ,  -0.324_dp ,'-' ,"phi"      ,     2, "soil", .False.)
  !field capacity transfer function
  gammaMeta(ixGamma%fc1gamma1)       = gammaPar_meta('fc1gamma1'      ,     1.0_dp ,'-' ,"fc"       ,     1, "soil", .False.)
  !wilting point transfer function
  gammaMeta(ixGamma%wp1gamma1)       = gammaPar_meta('wp1gamma1'      ,     1.0_dp ,'-' ,"wp"       ,     1, "soil", .False.)
  !residual transfer function
  gammaMeta(ixGamma%resid1gamma1)    = gammaPar_meta('resid1gamma1'   ,     0.2_dp ,'-' ,"resid"    ,     1, "soil", .False.)
  !transpire transfer function
  gammaMeta(ixGamma%transp1gamma1)   = gammaPar_meta('transp1gamma1'  ,     0.5_dp ,'-' ,"transp"   ,     1, "soil", .False.)
  !b transfer function
  gammaMeta(ixGamma%b1gamma1)        = gammaPar_meta('b1gamma1'       ,   3.100_dp ,'-' ,"b"        ,     1, "soil", .False.)
  gammaMeta(ixGamma%b1gamma2)        = gammaPar_meta('b1gamma2'       ,   0.157_dp ,'-' ,"b"        ,     1, "soil", .False.)
  gammaMeta(ixGamma%b1gamma3)        = gammaPar_meta('b1gamma3'       ,  -0.003_dp ,'-' ,"b"        ,     1, "soil", .False.)
  !saturation matric potential transfer function
  gammaMeta(ixGamma%psis1gamma1)     = gammaPar_meta('psis1gamma1'    ,   1.540_dp ,'-' ,"psis"     ,     1, "soil", .False.)
  gammaMeta(ixGamma%psis1gamma2)     = gammaPar_meta('psis1gamma2'    , -0.0095_dp ,'-' ,"psis"     ,     1, "soil", .False.)
  gammaMeta(ixGamma%psis1gamma3)     = gammaPar_meta('psis1gamma3'    ,  0.0063_dp ,'-' ,"psis"     ,     1, "soil", .False.)
  ...
  ! transfer function
  gammaMeta(ixGamma%binfilt1gamma1)  = gammaPar_meta('binfilt1gamma1' ,     0.0_dp ,'-' ,"binfilt"  ,     1, "soil", .False.)
  gammaMeta(ixGamma%binfilt1gamma2)  = gammaPar_meta('binfilt1gamma2' ,     1.0_dp ,'-' ,"binfilt"  ,     1, "soil", .False.)
  gammaMeta(ixGamma%D11gamma1)       = gammaPar_meta('D11gamma1'      ,     2.0_dp ,'-' ,"D1"       ,     1, "soil", .False.)
  gammaMeta(ixGamma%D21gamma1)       = gammaPar_meta('D21gamma1'      ,     2.0_dp ,'-' ,"D2"       ,     1, "soil", .False.)
  gammaMeta(ixGamma%D31gamma1)       = gammaPar_meta('D31gamma1'      ,     1.0_dp ,'-' ,"D3"       ,     1, "soil", .False.)
  gammaMeta(ixGamma%D41gamma1)       = gammaPar_meta('D41gamma1'      ,     2.0_dp ,'-' ,"D4"       ,     1, "soil", .False.)
  gammaMeta(ixGamma%expt1gamma1)     = gammaPar_meta('expt1gamma1'    ,     3.0_dp ,'-' ,"expt"     ,     1, "soil", .False.)
  gammaMeta(ixGamma%expt1gamma2)     = gammaPar_meta('expt1gamma2'    ,     2.0_dp ,'-' ,"expt"     ,     1, "soil", .False.)
  gammaMeta(ixGamma%bbl1gamma1)      = gammaPar_meta('bbl1gamma1'     ,    0.32_dp ,'-' ,"bbl"      ,     1, "soil", .False.)
  gammaMeta(ixGamma%bbl1gamma2)      = gammaPar_meta('bbl1gamma2'     ,     4.2_dp ,'-' ,"bbl"      ,     1, "soil", .False.)
  gammaMeta(ixGamma%bd1gamma1)       = gammaPar_meta('bd1gamma1'      ,     1.0_dp ,'-' ,"bd"       ,     1, "soil", .False.)
  gammaMeta(ixGamma%sd1gamma1)       = gammaPar_meta('sd1gamma1'      ,     1.0_dp ,'-' ,"sd"       ,     1, "soil", .False.)
  gammaMeta(ixGamma%WcrFrac1gamma1)  = gammaPar_meta('WcrFrac1gamma1' ,     1.0_dp ,'-' ,"WcrFrac"  ,     1, "soil", .False.)
  gammaMeta(ixGamma%WpwpFrac1gamma1) = gammaPar_meta('WpwpFrac1gamma1',     1.0_dp ,'-' ,"WcrFrac"  ,     1, "soil", .False.)
  gammaMeta(ixGamma%fsm1gamma1)      = gammaPar_meta('fsm1gamma1',          1.0_dp ,'-' ,"fsm"      ,     1, "soil", .False.)
  gammaMeta(ixGamma%zk1gamma1)       = gammaPar_meta('zk1gamma1',           1.6_dp ,'-' ,"zk"       ,     1, "soil", .False.)
  gammaMeta(ixGamma%zsk1gamma1)      = gammaPar_meta('zsk1gamma1',          1.6_dp ,'-' ,"zsk"      ,     1, "soil", .False.)
  gammaMeta(ixGamma%zsk1gamma2)      = gammaPar_meta('zsk1gamma2',          2.0_dp ,'-' ,"zsk"      ,     1, "soil", .False.)
